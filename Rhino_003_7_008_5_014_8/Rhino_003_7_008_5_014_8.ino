...
// ------------------ Seeder 5 -----------------------------------
    ...
    //-------------- Relay Low ------------------
    if ((BlockageCounter1 < BlockMaxLimit) && (BlockageCounter2 < BlockMaxLimit) && (BlockageCounter3 < BlockMaxLimit) && (BlockageCounter4 < BlockMaxLimit) && (BlockageCounter5 < BlockMaxLimit ))
    {
      digitalWrite(relayPin,LOW);
    }
  }
