...
//unsigned long dwell = 1000;
int d1_state = 0; //driver state ('0' - disable ; '1' - enable)
...
void check_seeder1()
{
  ...
  for(int i = 1;i<=BlockMaxLimit;i++)
  {
      ...
      //----------------- red indication ---------------
      // if (n1_feed_back == 0) //Enable if else condition to disable red indications on driver (i.e, when Motor stuck)
      //  {
      ...
      //   else 
        ...
        //       d1_state = 1;
        //   }
        //     if(((curr_millis - prev_millis) >= dwell) && d1_state == 0)
        //       {
        //         rmcs.Enable_Digital_Mode(n1_id,0);
        //         d1_state = 0;
...
if (config2 == 1 || config7 == 1 || config8 == 1 || config9 == 1 || config10 == 1 || config11 == 1 || config14 == 1|| config16 == 1 || config17 == 1)
  {
     ...
     //----------------------------------------
      ...
      if (FBSUL5 && FBSLL5) 
      {
        ...
        //  myFile.print(curr_time_ms);
        //  myFile.print(" : 5cond1 = ");
        //  myFile.println(CurrentRPM5);
