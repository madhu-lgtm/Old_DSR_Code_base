...
#include <FastLED.h>
#define LED_PIN     2
#define NUM_LEDS    24 //8_Seeders * 4_leds = 32 --> 7*4 = 28 --> 6*4
...
void check_relay()
{
  //-------------- Relay Low ------------------
    ...
    //   digitalWrite(relayPin,LOW);
    // }
    if ((BlockageCounter < BlockMaxLimit) && (BlockageCounter2 < BlockMaxLimit) && (BlockageCounter3 < BlockMaxLimit)&& (BlockageCounter4 < BlockMaxLimit) && (BlockageCounter5 < BlockMaxLimit ) && (BlockageCounter6 < BlockMaxLimit ))
    {
      digitalWrite(relayPin,LOW);
    } 
}
