// updated code for 5 modules (29-10-2025)
// update code for 6 modules (29-10-2025)
// updated code for 7 modules (29-10-2025)
...
#include <FastLED.h>
#define LED_PIN     2
#define NUM_LEDS    20 //8_Seeders * 4_leds = 32 --> 7*4 = 28 --> 6*4 = 24 --> 5*4 = 20
