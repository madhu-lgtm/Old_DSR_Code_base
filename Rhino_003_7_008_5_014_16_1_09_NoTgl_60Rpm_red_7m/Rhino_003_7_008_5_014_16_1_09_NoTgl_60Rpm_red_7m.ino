...
#include <FastLED.h>
#define LED_PIN     2
#define NUM_LEDS    28 //8_Seeders * 4_leds = 32 --> 7*4 = 28
...
void check_relay()
{
  //-------------- Relay Low ------------------
    ...
    //   digitalWrite(relayPin,LOW);
    // }
    if ((BlockageCounter < BlockMaxLimit) && (BlockageCounter2 < BlockMaxLimit) && (BlockageCounter3 < BlockMaxLimit)&& (BlockageCounter4 < BlockMaxLimit) && (BlockageCounter5 < BlockMaxLimit ) && (BlockageCounter6 < BlockMaxLimit ) && (BlockageCounter7 < BlockMaxLimit ))
    {
      digitalWrite(relayPin,LOW);
    } 
}
